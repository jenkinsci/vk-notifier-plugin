...
public class VkNotifierEndSendStep extends Step {
    private String peer;
    ...
    public StepExecution start(StepContext context) {
        return new StepExecution(context) {
            ...
            public boolean start() {
                ...
                try {
                    new VkNotifierSender(descriptor, getContext().get(Run.class), getContext().get(BuildListener.class)).sendEnd(peer, null);
